...
<div class="ds44-titleContainer ds44-titleContainer--home">
    <p role="heading" aria-level="1" class="h1-like ds44-text--colorInvert">
        <span class="ds44-block title-home"><%= obj.getTitreAffiche(userLang) %></span>
        <span class="ds44-ssTitreH1_home ds44-block ds44-mt1 subtitle-home" role="heading" aria-level="2"><%= obj.getSoustitre(userLang) %></span>
    </p>
