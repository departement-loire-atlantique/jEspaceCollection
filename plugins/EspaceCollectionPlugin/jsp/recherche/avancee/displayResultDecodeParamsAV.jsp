...
String redirectUrl = Util.notEmpty(request.getParameter("redirectUrl[value]")) ? request.getParameter("redirectUrl[value]") : "plugins/EspaceCollectionPlugin/jsp/recherche/avancee/displayResultAV.jsp";
