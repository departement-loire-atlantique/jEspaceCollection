...
<%--
  @Summary: GPLAContactBibliotheque editor
  @Category: Generated
...
<% String[] formTitles = JcmsUtil.getLanguageArray(channel.getTypeEntry(GPLAContactBibliotheque.class).getLabelMap()); %>
<jsp:useBean id='formHandler' scope='page' class='generated.EditGPLAContactBibliothequeHandler'>
...
<form action='<%= formAction %>' method='post' name='editForm' accept-charset="UTF-8"  enctype="multipart/form-data">
    ...
    <jsp:include page="doEditGPLAContactBibliotheque.jsp" />
