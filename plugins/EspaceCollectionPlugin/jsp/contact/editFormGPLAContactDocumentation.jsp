...
<%--
  @Summary: GPLAContactDocumentation editor
  @Category: Generated
...
<% String[] formTitles = JcmsUtil.getLanguageArray(channel.getTypeEntry(GPLAContactDocumentation.class).getLabelMap()); %>
<jsp:useBean id='formHandler' scope='page' class='generated.EditGPLAContactDocumentationHandler'>
...
<form action='<%= formAction %>' method='post' name='editForm' accept-charset="UTF-8"  enctype="multipart/form-data">
    ...
    <jsp:include page="doEditGPLAContactDocumentation.jsp" />
