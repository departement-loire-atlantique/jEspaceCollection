...
<% String[] formTitles = JcmsUtil.getLanguageArray(channel.getTypeEntry(GPLAContact.class).getLabelMap()); %>
<jsp:useBean id='formHandler' scope='page' class='generated.EditGPLAContactHandler'>
...
<form action='<%= formAction %>' method='post' name='editForm' accept-charset="UTF-8"  enctype="multipart/form-data">
    ...
    <jsp:include page="doEditGPLAContact.jsp" />
